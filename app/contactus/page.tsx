...
import logo1 from '@/assets/logos/Chilada logo 2 2.svg'
    ...
    <div className='bg-white flex flex-col mt-24'>
      ...
      <div className='flex flex-col justify-center items-center gap-y-32 mb-32'>
        ...
        <div className='flex justify-center items-center gap-x-16 w-10/12'>
          ...
          <div className='text-chiladaBlue-200 w-6/12 flex flex-col justify-center items-start gap-y-10'>
            ...
            <div className='flex justify-start items-center gap-x-4 border-2 border-chiladaBlue-200 rounded-lg bg-chiladaBlue-100 bg-opacity-50 py-3 pr-20 pl-6  cursor-pointer hover:bg-opacity-70'>
