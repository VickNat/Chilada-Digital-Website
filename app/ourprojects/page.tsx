      ...
      <div className={`h-[551px] bg-${theme.primaryColor} my-36 flex flex-col justify-start pt-10 items-center gap-8`}>
        ...
        <div className='flex justify-center items-center gap-x-10'>
          ...
          <div>
            ...
            <button
              // type="button"
              className={`bg-gradient-to-r from-white to-gray-300 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 shadow-md shadow-black font-medium rounded-full text-sm px-8 py-2.5 text-center mr-2 mb-2 cursor-pointer hover:from-gray-300 hover:to-white text-${theme.primaryColor}`}
            >
              Contact Us
            </button>
          </div>
